...
const LOG: debug.IDebugger = debug('Jupiter:FabricService');
...
export class EarthFabricService {
  ...
  constructor(configs?: string[], chaincodeId?: string) {
    if (configs) {
    ...
    this.chaincodeId = 'e24ea80d-d703-47a3-88af-1c69f21b025d';
